...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeployOption) DeepCopyInto(out *DeployOption) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeployOption.
func (in *DeployOption) DeepCopy() *DeployOption {
	if in == nil {
		return nil
	}
	out := new(DeployOption)
	in.DeepCopyInto(out)
	return out
}
